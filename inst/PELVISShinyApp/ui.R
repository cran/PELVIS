shinyUI(fluidPage(theme="kappa.css",
  ...
  titlePanel(img(src="banner_PELVIS.png", height="40px"), windowTitle="PELVIS"),
  ...
  tabPanel("Data input: from text file",
    verticalLayout(
       wellPanel(
        ...
        actionButton("loadData", "Load dataset", icon=icon("file-upload")), # bouton de chargement de donnees (server.R attend un clic sur ce bouton pour demarrer)
